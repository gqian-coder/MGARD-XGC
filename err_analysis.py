...
plt.close()
plt.figure()
plt.plot(L_inf, alpha=1.0, label = 'by flux surface reconstruction')
plt.plot(err_ori, alpha=0.5, label = 'original reconstruction')
...
plt.close()
plt.figure()
plt.plot(L_inf_perc, alpha=1.0, label = 'by flux surface reconstruction')
plt.plot(err_ori_perc, alpha=0.5, label = 'original reconstruction')
